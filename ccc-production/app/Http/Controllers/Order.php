...
class Order extends Controller
{
    public function displayOrderAction(Request $request)
    {
        try
        {
           ...
           $cartModel = CartModel::find($cartId);
               ...
               return view('order.grid',['comments'=>$comments,'controller'=>$this,'customer'=>$customer,'orderDetails'=>$orderDetails,'orderItemsDetails'=>$orderItemsDetails,'orderBillingAddressDetails'=>$orderBillingAddressDetails,'orderShippingAddressDetails'=>$orderShippingAddressDetails]);
    ...
    public function manageOrderAction()
    {
      ...
      return view('order.manageOrder',['controller'=>$this,'customerAddress'=>$customerAddress,'customerDetails'=>$customerDetails]);    }
    ...
    public function displayAllOrderAction($id=null  ,Request $request)
    {
       $orderId = $id;
        ...
        $orderShippingAddressDetails = OrderAddress::where([['orderId',$orderId],['addressType','shipping']])->get();
        $comments = Comments::where('orderId', $orderId)->get();
         return view('order.information',['comments'=>$comments,'controller'=>$this,'customerDetails'=>$customerDetails,'orderDetails'=>$orderDetails,'orderItemsDetails'=>$orderItemsDetails,'orderBillingAddressDetails'=>$orderBillingAddressDetails,'orderShippingAddressDetails'=>$orderShippingAddressDetails]);
