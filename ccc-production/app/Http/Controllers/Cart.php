...
class Cart extends Controller
{
    ...
    try{
      ...
      $customerId = Session::get('customerId');
        ...
        if($customerId)
        {
          ...
          return view('cart.grid',['products'=>$pagination,'customers'=>$customers,'cart'=>$cartView,'cartItems'=>$cartItems,'customerId'=>$customerId,'controller'=>$this,'cartId'=>$cartId,'shipping'=>$cartShippingAddress,'billing'=>$cartBillingAddress]);
    }catch (\Exception $e) {
        echo  $e->getMessage();
     }
    }
    ...
    public function fetch_cartdata(Request $request)
    {
        if($request->ajax())
        {
            ...
            return view('cart.grid',['productId'=> $productId,'products'=>$pagination,'customers'=>$customers,'cart'=>$cartView,'cartItems'=>$cartItems,'customerId'=>$customerId,'controller'=>$this,'cartId'=>$cartId,'shipping'=>$cartShippingAddress,'billing'=>$cartBillingAddress]);
