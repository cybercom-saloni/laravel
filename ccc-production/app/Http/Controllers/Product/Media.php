...
class Media extends Controller
{
    ...
    //             $source = imagecreatefromjpeg($request->image);
    //             imagecopyresized($newImage,$source,0,0,0,0,$width,$height,$imageWidth,$imageHeight);
    //              $resizeImageName= time().'.jpg';
    //             imagejpeg($newImage,public_path("images/products/cache/100x100/$resizeImageName"));
    //             $nwidth = 200;
    //             $nheight = 200;
    //             $nnewImage = imagecreatetruecolor($nwidth,$nheight);
    //             $nsource = imagecreatefromjpeg($request->image);
    //             imagecopyresized($nnewImage,$nsource,0,0,0,0,$nwidth,$nheight,$imageWidth,$imageHeight);
    //             imagejpeg($nnewImage,public_path("images/products/cache/200x200/$resizeImageName"));
    ...
    //             $height = 100;
    //             $newImage = imagecreatetruecolor($width,$height);
    //             $source = imagecreatefrompng($request->image);
    //             imagecopyresized($newImage,$source,0,0,0,0,$width,$height,$imageWidth,$imageHeight);
    //              $resizeImageName= time().'.png';
    //             imagepng($newImage,public_path("images/products/cache/100x100/$resizeImageName"));
    //             $nwidth = 200;
    //             $nheight = 200;
    //             $nnewImage = imagecreatetruecolor($nwidth,$nheight);
    //             $nsource = imagecreatefrompng($request->image);
    //             imagecopyresized($nnewImage,$nsource,0,0,0,0,$nwidth,$nheight,$imageWidth,$imageHeight);
    //             imagepng($nnewImage,public_path("images/products/cache/200x200/$resizeImageName"));
    //             $request->image->move(public_path("images/products/$id"), $imageName);
    //            }
    ...
    //             $height = 100;
    //             $newImage = imagecreatetruecolor($width,$height);
    //             $source = imagecreatefromgif($request->image);
    //             imagecopyresized($newImage,$source,0,0,0,0,$width,$height,$imageWidth,$imageHeight);
    //              $resizeImageName= time().'.png';
    ...
    //             $nheight = 200;
    //             $nnewImage = imagecreatetruecolor($nwidth,$nheight);
    //             $nsource = imagecreatefromgif($request->image);
    //             imagecopyresized($nnewImage,$nsource,0,0,0,0,$nwidth,$nheight,$imageWidth,$imageHeight);
    //             imagegif($nnewImage,public_path("images/products/cache/200x200/$resizeImageName"));
    //             $request->image->move(public_path("images/products/$id"), $imageName);
    //            }
    //         }
    //     return \redirect('/product/media/' . $id)->with('productUpload', 'product Media Uploaded successfully!!!');
