                            ...
                            <form action="/admin/formNameEditSave/{{$attributeEdit->id}}" method="post" id="form">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <select name="attribute[entity_type_id]" id="entity_type_id" class="form-control"  required>
                                            ...
                                            @foreach($controller->getAllEntityName() as $key =>$value)
                                                <option value="{{$value->id}}" {{$attributeEdit ? ($attributeEdit->entity_type_id == $value->id? 'selected' : ''): ' '}}>{{$value->entity_name}} </option>
                                            @endforeach
                                ...
                                <div class="form-group col-lg-12">
                                    <label for="name">Slug</label>
                                        <input type="text" class="form-control" name="attribute[slug]" value="{{$attributeEdit->slug}}" id="slug" aria-describedby="helpId" placeholder="Entity Slug" data-validation="required length" data-validation-length="min2">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <select name="attribute[backend_type]" id="backendType" class="form-control"  data-validation="required">
                                             ...
                                             <option value="{{$value}}" {{$attributeEdit ? ($attributeEdit->backend_type == $value? 'selected' : ''): ' '}}>{{$value}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group col-lg-12">
                                    <label for="name">Validation</label>
                                        <input type="text"  value="{{$attributeEdit->validation}}" class="form-control" name="attribute[validation]" id="placeholder" aria-describedby="helpId" placeholder="Attribute Validation">
                                </div>
                                <div class="form-group col-lg-12">
                                    <label for="name">style</label>
                                        <input type="text"  value="{{$attributeEdit->style}}" class="form-control" name="attribute[style]" id="style" aria-describedby="helpId" placeholder="Attribute Style">
                                </div>
                                <div class="form-group col-lg-12">
                                ...
                                <div class="form-group col-lg-12">
                                    <center><button type="submit" name="saveCategory" id="update" class="btn  btn-lg btn-secondary">Edit Attribute</button></center>
                                </div>
                            </form>
                        </div>
                    </div>
