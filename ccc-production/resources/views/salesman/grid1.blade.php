                                    ...
                                    <form action="" method="POST" id="form">
                                      @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4"></div>
                                            @else
                                            <div class="col-4"><button type="button" id="update" class="btn btn-md btn-primary" onclick="myFunction()"><i class="fa fa-pencil"></i>UPDATE
                                            </button></td></div>
                                            @endif
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                <ul></ul>
                                                   ...
                                                   <td></td>
                                                    ...
                                                    <td colspan='2'><button type="button" class="btn btn-md btn-primary"><i class="fa fa-plus" onclick="object.changeAction('form','SalesmanAddNewProduct/{{$salesId}}')"></i></button></td>

                                                  <!--   <i class="fa fa-plus" onclick="object.setUrl('SalesmanAddNewProduct/{{$salesId}}').setForm('form').load();"></i> -->
                                                </tr>
