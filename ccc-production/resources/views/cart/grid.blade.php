            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-headline" style="background-color: ghostwhite;">
                        <div class="panel-heading">
                            <h3 class="panel-title">Manage Cart</h3>
                        </div>
            ...
            <div class=" form-group row">
                        ...
                        <div class=" form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="checkbox"  id="billingsaveInAddressBook"  onclick="billingsaveInAddressBookFunction();"  name="billing[saveInAddressBook]" placeholder="saveInAddressBook" >
                            </div>
                        </div>
                </div>
                <div class="col-6">
                ...
                <div class=" form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="checkbox"  onclick="sameAsBillingFunction();" id="sameAsBilling" name="shipping[sameAsBilling]" placeholder="saveInAddressBook"   >
                            </div>
                </div>
                <div class=" form-group row">
                            <div class="col-lg-4">
                        ...
                        <div class=" form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="checkbox"  id="shippingsaveInAddressBook"onclick="shippingsaveInAddressBookFunction();" name="shipping[saveInAddressBook]" placeholder="saveInAddressBook"   >
                            </div>
                        </div>
                </div>
            </div>
...
<button type="submit"  class="btn btn-md btn-success">UPDATE</button><br>
</form>
<br>
...
<button type="submit" name="addToCart" id="addToCart" class="btn btn-primary btn-md">Add Items To Cart</button>
    <hr>
...
@csrf
    ...
    <button type="submit"  id="cartItemUpdatebtn" class="btn btn-md btn-success">UPDATE CART</button>
    ...
    @endif
        ...
        <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/cartItem/delete/{{$cartItem->id}}" class="btn btn-secondary">DELETE</a></td>
                    </tr>
                    @endforeach
                    <tr>
...
<a href="/order/{{Session::get('cartId')}}" class="btn btn-md btn-warning">Place Order</a>
<script>
